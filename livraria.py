...
def comprar_livro():
    ...
    # Busca o preço base
    valor_base = tabela_precos.get(titulo, 0) # Usa .get para segurança
    
    # Se o livro não tiver preço na tabela (improvável, mas seguro), cancela.
    if valor_base == 0:
        print(f"Erro: Preço de referência para '{titulo}' não encontrado.")
        return
